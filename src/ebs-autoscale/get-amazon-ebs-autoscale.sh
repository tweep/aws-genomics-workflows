...
function install() {
    ...
    sh /opt/amazon-ebs-autoscale/install.sh -d /dev/xvdba -f $filesystem -m /var/lib/docker -t io2 --volume-iops 100000  --volume-throughput 2000 --min-ebs-volume-size 1000 > /var/log/ebs-autoscale-install.log 2>&1
